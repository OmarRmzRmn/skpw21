...
<?php if(!empty($_SESSION['CARRITO'])) { ?>
                    ...
                    <form action="pago.php" method = "post">
                        <div class="alert alert success">
                                <div class="form-group">
                                    ...
                                    <?php if(!empty($user)){?> value=<?php $_POST['EMAIL']; }
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label>
                                <input id="metodo" name="tarjeta" type="radio">Tarjeta
                                <input id="metodo" name="paypal" type="radio">PayPal
                            </label>
                        </div>
                        <button class="btn btn-primary btn-lg btn-block" type="submit" name="btnAccion" value="PagarCompra">Pagar</button>
                    </form>
                </td>
            </tr>
        </tbody>
    ...
    <a class="btn btn-primary" href="reportes.php"> Recibo_PDF</a>
<?php } else{?>
